...
# Adaptive integrated controller resume preset for CelebA-HQ 256px / 32x32 latents.
# Matches the 2026-05-05 adaptive_integrated_controller_hierarchy_celebahq256
# run config so training can resume from its 0090000 checkpoint without changing
# the model/router structure.
...
export CKPT="${CKPT:-/SSD4/yjjung/MoH/Mixture-of-Hierarchy-Mamba/outputs/hierarchy_hybrid_local_v2_facehq_1024_bs16/2026-05-05_05-16-42_adaptive_integrated_controller_hierarchy_celebahq256/checkpoints/0090000.pt}"
