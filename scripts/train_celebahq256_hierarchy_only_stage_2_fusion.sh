...
FUSION_BLOCK_DEPTH="${FUSION_BLOCK_DEPTH:-2}"
FUSION_STAGE_DEPTH_OVERRIDES="${FUSION_STAGE_DEPTH_OVERRIDES:-16:1}"
...
usage() {
  cat <<'EOF'
Usage: bash zigma/scripts/train_celebahq256_hierarchy_only_stage_2_fusion.sh [--ckpt PATH]
