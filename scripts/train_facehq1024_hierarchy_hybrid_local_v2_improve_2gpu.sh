...
# Improvement-focused preset:
# strengthens high-resolution skip usage and final detail cleanup while
# keeping standard convolutions for safer optimization than separable variants.
...
export FUSION_STAGE_DEPTH_OVERRIDES="${FUSION_STAGE_DEPTH_OVERRIDES:-16:3,32:5}"
export FUSION_CHANNEL_GATE_STAGES="${FUSION_CHANNEL_GATE_STAGES:-8,16,32}"
export FUSION_PRE_MAMBA_CONV_DEPTH="${FUSION_PRE_MAMBA_CONV_DEPTH:-1}"
export FUSION_POST_MAMBA_CONV_DEPTH="${FUSION_POST_MAMBA_CONV_DEPTH:-2}"
export ANCHOR_BUILDER_DEPTH="${ANCHOR_BUILDER_DEPTH:-2}"

export PREDICTION_HEAD_CONV_DEPTH="${PREDICTION_HEAD_CONV_DEPTH:-4}"
